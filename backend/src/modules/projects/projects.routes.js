 ...
 * applies the required validation and authentication middleware.
 *
 * Available endpoints:
 * - GET    /          Retrieve all projects (optional filtering by type).
 * - GET    /:id       Retrieve a single project by its ID.
 * - POST   /          Create a new project (Admin only).
 * - PATCH  /:id       Update an existing project (Admin only).
 ...
 * 3. Validate request parameters, body, or query.
